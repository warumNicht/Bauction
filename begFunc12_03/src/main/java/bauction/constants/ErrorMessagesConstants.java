package bauction.constants;

public class ErrorMessagesConstants {

    public static final String NOT_EXISTENT_AUCTION_MESSAGE= "Auction with the given id was not found!";

    public static final String NOT_EXISTENT_USER_ID_MESSAGE= "User with the given id was not found!";
