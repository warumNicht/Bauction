...
public interface DealRepository extends JpaRepository<Deal,Integer> {
    ...
    List<Deal> allRecentDealsOfUser(@Param(value = "id")Integer userId,@Param(value = "deadline") Date date);
...
//            "ORDER BY d.dateTime DESC")
    ...
    @Query(value = "SELECT d FROM Deal d " +
            ...
            "GROUP BY d.id " +
            "ORDER BY d.dateTime DESC ")
    List<Deal> allDealsWithCommentOfUser(@Param(value = "id")Integer userId);
}
